...
[Jena climate dataset](https://www.kaggle.com/datasets/trnvquanghuy/jena-climate) is used across several chapters, with a summary of the performance of the models used at the end.
